      ...
      <v-card outlined>
        <v-card-text>
          ...
          <v-select v-if="groups" v-model="user.group" disabled :items="groups" rounded class="rounded-lg"
            item-text="name" item-value="name" :return-object="false" filled :label="$t('group.user-group')"
            :rules="[validators.required]" />
          <v-select v-if="households" v-model="user.household" :items="households" rounded class="rounded-lg"
            item-text="name" item-value="name" :return-object="false" filled :label="$t('household.user-household')"
            :rules="[validators.required]" />
