  ...
  <div>
    ...
    <v-row :no-gutters="mdAndUp" density="compact" class="d-flex flex-wrap my-1">
      <v-col v-if="!disableAmount" sm="12" md="2" cols="12" class="flex-grow-0 flex-shrink-0">
        <v-text-field v-model="modelValue.quantity" variant="solo" hide-details density="compact" type="number"
      ...
      <v-col sm="12" md="" cols="12">
        <div class="d-flex">
          <v-text-field v-model="modelValue.note" hide-details density="compact" variant="solo" :placeholder="$t('recipe.notes')"
