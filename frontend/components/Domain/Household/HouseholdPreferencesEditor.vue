<template>
	<div v-if="preferences">
		<BaseCardSectionTitle class="mt-10"
			:title="$t('household.household-preferences')"
		/>
		<div class="mb-6">
			<v-checkbox v-model="preferences.privateHousehold"
				hide-details
				density="compact"
		...
		<div class="mb-6">
			<v-checkbox v-model="preferences.lockRecipeEditsFromOtherHouseholds"
				hide-details
				density="compact"
		...
		<v-select v-model="preferences.firstDayOfWeek"
		...
		<BaseCardSectionTitle class="mt-5"
			:title="$t('household.household-recipe-preferences')"
		/>
		<div class="preference-container">
			<div v-for="p in recipePreferences"
				:key="p.key"
			>
				<v-checkbox v-model="preferences[p.key]"
					hide-details
					density="compact"
					:label="p.label"
				/>
